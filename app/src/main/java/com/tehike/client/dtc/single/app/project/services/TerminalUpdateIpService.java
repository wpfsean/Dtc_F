...
import com.tehike.client.dtc.single.app.project.ui.DtcDutyMainActivity;
...
//                }
                ...
                String data = "WHOAMI|" + nativeMac.toUpperCase().replace(":", "-") + "|" + nativeIp
                        + "/" + nativeNetmask + "/" + nativeGateway + "|TH-S6000-V2.0";
    ...
    class RebootThread extends Thread {
        ...
        public void run() {
            if (serverMac.equals(nativeMac.toUpperCase().replace(":", "-"))) {
                ...
                //重启应用
                Intent intent = App.getApplication().getPackageManager().getLaunchIntentForPackage("com.tehike.client.dtc.single.app.project");
