...
import com.tehike.client.dtc.single.app.project.entity.VideoGroupInfoBean;
import com.tehike.client.dtc.single.app.project.global.AppConfig;
import com.tehike.client.dtc.single.app.project.onvif.ControlPtzUtils;
import com.tehike.client.dtc.single.app.project.ui.BaseFragment;
import com.tehike.client.dtc.single.app.project.ui.views.OnMultiTouchListener;
...
import com.tehike.client.dtc.single.app.project.utils.PageModel;
...
public class VideoMonitorFragment extends BaseFragment implements NodePlayerDelegate, OnOpenSerialPortListener {
    ...
    private void initializeSerialPort() {
        ...
        Logutil.d("摇杆Status-->>" + openSerialPort);
    }
    ...
    public void onSuccess(File device) {
        Log.i("TAG", device.getPath() + "Open Success");
