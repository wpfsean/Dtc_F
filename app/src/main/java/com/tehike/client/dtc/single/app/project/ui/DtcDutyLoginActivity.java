...
import com.tehike.client.dtc.single.app.project.services.LocationService;
...
import com.tehike.client.dtc.single.app.project.update.AppUtils;
...
//
//        List<AlarmTypeBean>  mAlarmTypeList = GsonUtils.GsonToList(CryptoUtil.decodeBASE64(FileUtil.readFile(AppConfig.ALARM_COLOR).toString()), AlarmTypeBean.class);
//        Logutil.d("mAlarmTypeList-->>"+mAlarmTypeList.toString());
